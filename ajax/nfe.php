...
/**
 *       \file       htdocs/fiscal/ajax/nfe.php
 *       \brief      File to return Ajax response on nfe list request
 */
...
// Security check
if (!$user->hasRight('fiscal', 'nfe', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax fiscal/ajax/nfe.php");
