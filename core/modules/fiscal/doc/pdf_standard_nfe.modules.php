...
/**
 *  \file       core/modules/fiscal/doc/pdf_standard.modules.php
 *  \ingroup    fiscal
...
/**
 *	Class to manage PDF template standard_nfe
 */
class pdf_standard_nfe extends ModelePDFNFe
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if (getDolGlobalString('FISCAL_NFE_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			$this->watermark = getDolGlobalString('FISCAL_NFE_DRAFT_WATERMARK');
		}
		...
		/*
		if (getDolGlobalInt('MAIN_GENERATE_NFE_WITH_PICTURE'))) {
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	NFe	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('FISCAL_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('FISCAL_DRAFT_WATERMARK')));
		}
